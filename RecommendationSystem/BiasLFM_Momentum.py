...
#                    print step,'a',err_ui
                    ...
                    menbu[user] = mu * menbu.get(user,0) + dbu[user] 
                    menbi[item] = mu * menbi.get(item,0) + dbi[item] 

                    self.bu[user] += self.alpha * menbu[user]
                    self.bi[item] += self.alpha * menbi[item]
                    ...
                    for k in xrange(self.K):
                        ...
                        menp[user][k] = mu * menp[user].get(k,0) + dp[user][k]
                        menq[item][k] = mu * menq[item].get(k,0) + dq[item][k] 
                        self.P[user][k] += self.alpha * menp[user][k]
                        self.Q[item][k] += self.alpha * menq[item][k]
