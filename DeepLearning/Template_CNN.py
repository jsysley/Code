# -*- coding: utf-8 -*-
"""
Created on Wed May 10 16:51:13 2017
...
n_hiddens = 128             # neurons in hidden layer
n_classes = 10              # MNIST classes (0-9 digits)
n = 55000                   # Samples size
display_epoch = 1           # display the result

# tf Graph input
xs = tf.placeholder("float", [None, n_inputs])
...
with tf.Session() as sess:
    ...
    for epoch in range(iterations):
        ...
        if epoch % display_epoch == 0:
            print("CNN-Epoch:", '%04d' % (epoch+1), "cost= ","%.9f" % avg_loss)
    ...
    plt.show()
    #save_path = saver.save(sess,"F:/code/python3/DeepLearning/MyNet.ckpt")
