...
cnn = CNN(lr = 1e-4,keep_prob = 1,iterations = 20,batch_size = 100,
          n_inputs = 784,n_hiddens = 128,n_classes = 10,n = 55000,display_epoch = 1)
cnn.train(mnist.train.images,mnist.train.labels)
cnn.test(mnist.test.images,mnist.test.labels)
cnn.save(r'F:/code/python3/DeepLearning/template/record/model.ckpt')

cnn1 = CNN(lr = 1e-4,keep_prob = 1,iterations = 1,batch_size = 100,
          n_inputs = 784,n_hiddens = 128,n_classes = 10,n = 55000,display_epoch = 1)
cnn1.load(r'F:/code/python3/DeepLearning/template/record/model.ckpt')
cnn1.test(mnist.test.images,mnist.test.labels)
